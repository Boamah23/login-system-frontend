...
import security from "../securityQ&As"
        ...
        <Layout>
          <Sider width={200}>
            ...
            >
              ...
              <Menu.Item key="3"><Link to="/security" />Security Questions</Menu.Item>
              <Menu.Item key="4"><Link to="/resetPass" />Reset Password</Menu.Item>
              <Menu.Item key="5"><Link to="/deactivate" />Deactivate</Menu.Item>
              <Menu.Item key="6"><Link to="/deleteAcc" />Delete Account</Menu.Item>
            </Menu>
          </Sider>
